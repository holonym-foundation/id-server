...
function createPostSessionRouteHandler(config: SandboxVsLiveKYCRouteHandlerConfig) {
  return async (req: Request, res: Response) => {
    try {
      ...
      console.log("POST /veriff-aml-sessions: Error encountered", makeUnknownErrorLoggable(err));
...
function createPostSessionv2RouteHandler(config: SandboxVsLiveKYCRouteHandlerConfig) {
  return async (req: Request, res: Response) => {
    try {
      ...
      console.log("POST /aml-sessions/v2: Error encountered", makeUnknownErrorLoggable(err));
      return res.status(500).json({ error: "An unknown error occurred" });
    }
  };
}
...
async function createPayPalOrder(req: Request, res: Response) {
  ...
  try {
    ...
    console.log("payForSession: Error encountered", makeUnknownErrorLoggable(err));
    return res.status(500).json({ error: "An unknown error occurred" });
  }
}
...
async function payForSession(req: Request, res: Response) {
  ...
  try {
    ...
    console.log("payForSessionV2: Error encountered", makeUnknownErrorLoggable(err));
    return res.status(500).json({ error: "An unknown error occurred" });
  }
}
...
async function payForSessionV2(req: Request, res: Response) {
  ...
  try {
    ...
    console.log("payForSessionV3: Error encountered", makeUnknownErrorLoggable(err));
...
async function payForSessionV3(req: Request, res: Response) {
  ...
  try {
    ...
    console.error({ error: makeUnknownErrorLoggable(err) }, "Error creating IDV session");
...
async function refund(req: Request, res: Response) {
  ...
  try {
    ...
    console.log("POST refund AML checks session: Error encountered", makeUnknownErrorLoggable(err));
    return res.status(500).json({ error: "An unknown error occurred" });
  }
}
...
function createIssueCredsV4RouteHandler(config: SandboxVsLiveKYCRouteHandlerConfig) {
  return async (req: Request, res: Response) => {
    try {
      ...
      console.error(makeUnknownErrorLoggable(err));
      return res.status(500).json({ error: "An unknown error occurred" });
    }
  };
}
