...
import { IOrder, ISandboxOrder } from "../types.js";
dotenv.config();
...
export const SandboxOrderSchema = new Schema<ISandboxOrder>({
  holoUserId: { type: String, required: true },
  externalOrderId: { type: String, required: true },
  category: { type: String, required: true },
  fulfilled: { type: Boolean, default: false,required: true },
...
// SandboxOrderSchema.index({ externalOrderId: 1 })
// SandboxOrderSchema.index({ txHash: 1 })
